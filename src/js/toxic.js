export default {
  ...
  "sources": {
    "vectorTiles": {
      ...
      "minzoom": 0,
      "tiles": [
        "https://a.api.tomtom.com/map/2/tile/basic/{z}/{x}/{y}.pbf?key=NNnVPoPM9wVe2TNRA93zMuE6cKBdP2M0",
        "https://b.api.tomtom.com/map/2/tile/basic/{z}/{x}/{y}.pbf?key=NNnVPoPM9wVe2TNRA93zMuE6cKBdP2M0",
        "https://c.api.tomtom.com/map/2/tile/basic/{z}/{x}/{y}.pbf?key=NNnVPoPM9wVe2TNRA93zMuE6cKBdP2M0",
        "https://d.api.tomtom.com/map/2/tile/basic/{z}/{x}/{y}.pbf?key=NNnVPoPM9wVe2TNRA93zMuE6cKBdP2M0"
      ],
      "type": "vector"
    }
  },
  "sprite": "https://api.tomtom.com/style/1/sprite/24.1.0-17/sprite?map=2%2Fbasic_street-dark&key=NNnVPoPM9wVe2TNRA93zMuE6cKBdP2M0",
  "glyphs": "https://api.tomtom.com/style/1/glyph/24.1.0-17/{fontstack}/{range}.pbf?key=NNnVPoPM9wVe2TNRA93zMuE6cKBdP2M0",
  "layers": [
    {
      "id": "background",
      "type": "background",
    ...
    },
    {
      ...
      "paint": {
        "fill-color": "hsla(172, 25%, 20%, 1)",
        "fill-outline-color": "hsla(175, 10%, 10%, 0.3)"
      }
    },
    {
      "id": "Water - Shadow",
    ...
    },
    {
      ...
      "paint": { "fill-color": "hsl(214, 24%, 36%)" }
    },
    {
      "id": "Water - Line",
      "type": "line",
    ...
    },
    {
      ...
      "paint": { "fill-color": "hsla(210, 12%, 22%, 0.5)" }
    },
    {
      "id": "Buildings - Shadow",
      "type": "fill",
    ...
    },
    {
      ...
      "paint": {
        ...
        "line-opacity": ["interpolate", ["linear"], ["zoom"], 15, 0.25, 17, 1],
      ...
      "paint": {
        ...
        "line-width": [
          ...
          [
            ...
            ["match", ["get", "subcategory"], ["parking"], 0, 0.5]
          ],
          19,
          [
            "match",
    ...
    },
    {
      ...
      "layout": { "line-cap": "round", "line-join": "round" },
      "paint": {
        "line-color": "hsla(220, 16%, 10%, 0.75)",
    ...
    },
    {
      ...
      "paint": {
        "line-color": {
          "stops": [[3, "hsl(210, 6%, 27%)"], [8, "hsl(214, 8%, 31%)"]]
        },
    ...
    },
    {
      ...
      "paint": {
        "text-color": "hsl(216, 20%, 55%)",
        "text-halo-color": "hsla(0, 0%, 10%, 0.5)",
        "text-halo-width": 1
      }
    },
    {
      ...
      "paint": {
        ...
        "text-halo-color": "hsla(0, 0%, 20%, 0.75)",
    ...
    },
    {
      ...
      "paint": {
        "text-color": {
          "property": "shield_icon_text_color_night_3",
          "type": "identity"
        }
      }
    },
    {
      ...
      "paint": {
        "text-color": {
          "property": "shield_icon_text_color_night_2",
          "type": "identity"
        }
      }
    },
    {
      ...
      "paint": {
        "text-color": {
          "property": "shield_icon_text_color_night_1",
          "type": "identity"
        }
      }
    },
    {
      ...
      "paint": {
        "text-color": {
          "property": "shield_icon_text_color_night_0",
          "type": "identity"
        }
      }
    },
      ...
      "paint": {
        ...
        "text-halo-color": {
          ...
          "stops": [
            ...
            ["school", "hsl(31, 20%, 35%)"],
            ["hospital", "hsl(8, 63%, 38%)"],
            ["amusement_park", "hsl(324, 35%, 40%)"],
            ["museum", "hsl(324, 40%, 45%)"],
            ["park_and_recreation_area", "hsl(160, 43%, 24%)"],
            ["zoo_arboreta_and_botanical_garden", "hsl(324, 35%, 40%)"],
            ["shopping_center", "hsl(291, 29%, 45%)"],
            ["golf_course", "hsl(160, 43%, 24%%)"],
            ["stadium", "hsl(324, 35%, 40%)"],
            ["tourist_attraction", "hsl(160, 43%, 24%)"],
            ["place_of_worship", "hsl(324, 8%, 35%)"],
            ["airport", "hsl(210, 58%, 28%)"],
            ["ferry_terminal", "hsl(198, 40%, 35%)"],
            ["public_transportation_stop", "hsl(210, 58%, 32%)"],
            ["railroad_station", "hsl(210, 58%, 32%)"],
            ["geographic_feature", "hsl(160, 43%, 24%)"]
          ],
          "type": "categorical"
        },
        "text-halo-width": 1
    ...
    },
    {
      ...
      "paint": {
        "text-color": "hsl(0, 0%, 80%)",
        "text-halo-color": "hsla(210, 15%, 10%, 1)",
